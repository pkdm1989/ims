...
<form name="registration" method="post" action="cregistration.php">
...
Else
{
$sql="insert into candidates_".$_REQUEST['driveid']." (name,username,password,phno) values('".$_REQUEST['name']."', '".$_REQUEST['username']."', '".$_REQUEST['password']."','".$_REQUEST['phno']."')";
